...
-----------------------------------------------------------------
./src/test/java/org/mule/demo/muledemosalesforce2mongo/Muledemosalesforce2mongoTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/muledemosalesforce2mongo-functional-test-config.xml

Defines the Mule configuration for the Muledemosalesforce2mongoTestCase.java.
...
artifactId=muledemosalesforce2mongo
description=SalesForce to Mongo Demo
muleVersion=3.1.2
packagePath=org/mule/demo
forgeProject=n
transports=file,http,jdbc,jms,vm
modules=client,cxf,management,scripting,sxc,xml

version=1.0-SNAPSHOT
groupId=org.mule.demo
